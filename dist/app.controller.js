    ...
    async getEncoded(url) {
        if (validUrl.isUri(url) != undefined) {
            ...
            if (operation == undefined) {
                ...
                operation = await this.appService.createOperation(new operation_schema_1.OperationDocumentDto(url, shortened, 'encode'));
            }
            return {
                url: operation.url,
...
], AppController.prototype, "getEncoded", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], AppController.prototype, "getDecoded", null);
